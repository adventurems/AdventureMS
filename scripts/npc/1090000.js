...
function action(mode, type, selection) { if (mode == 1) {status++;} else {status--;} if (status == -1) {cm.dispose();}
    ...
    else if (status == 0)
    {
        ...
        else if (cm.getLevel() >= 30 && Job == 500)
        {
            /*/ Disable 2nd job
            ...
            if (cm.getZoneProgress() == 3)
            {
                ...
                "\r\n\r\n#r#eThis decision is FINAL! Which class would you like to be#k#n?\r\n\r\n#L1#I'd like to be a #rBrawler#k!#l\r\n#L2#I'd like to be a #rGunslinger#k!#l");
            }
    ...
    else if (status == 1)
    {
        ...
        else if (actionx["2ndJob"])
        {
            ...
            if (selection == 1) {newJob = 510; newJobName = "Brawler";} else if (selection == 2) {newJob = 520; newJobName = "Gunslinger";}
