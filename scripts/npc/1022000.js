...
function action(mode, type, selection) { if (mode == 1) {status++;} else {status--;} if (status == -1) {cm.dispose();}
    ...
    else if (status == 0)
    {
        ...
        else if (cm.getLevel() >= 30 && Job == 100)
        {
            ...
            if (cm.getZoneProgress() == 3)
            {
                ...
                "\r\n\r\n#r#eThis decision is FINAL! Which class would you like to be#k#n?\r\n\r\n#L1#I'd like to be a #rFighter#k!#l\r\n#L2#I'd like to be a #rPage#k!#l\r\n#L3#I'd like to be a #rSpearman#k!#l");
            }
    ...
    else if (status == 1)
    {
        ...
        else if (actionx["2ndJob"])
        {
            ...
            if (selection == 1) {newJob = 110; newJobName = "Fighter";} else if (selection == 2) {newJob = 120; newJobName = "Page";} else if (selection == 3) {newJob = 130; newJobName = "Spearman";}
