...
function action(mode, type, selection) { if (mode == 1) {status++;} else {status--;} if (status == -1) {cm.dispose();}
    ...
    else if (status === 0)
    {
        ...
        else if (cm.getLevel() >= 30 && Job === 300)
        {
            ...
            if (cm.getZoneProgress() == 3)
            {
                ...
                "\r\n\r\n#r#eThis decision is FINAL! Which class would you like to be#k#n?\r\n\r\n#L0#I'd like to be a #rHunter#k!#l\r\n#L1#I'd like to be a #rCrossbowman#k!#l");
            }
    ...
    else if (status === 1)
    {
        ...
        else if (actionx["2ndJob"])
        {
            ...
            if (selection === 0) {newJob = 310; newJobName = "Hunter";} else if (selection === 1) {newJob = 320; newJobName = "Crossbowman";}
